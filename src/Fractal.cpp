...
void Fractal::color(unsigned int* bitmapPosition, const double* r, const double* g, const double* b)
{
   m_bitmap[(*bitmapPosition)++] = *r;
   m_bitmap[(*bitmapPosition)++] = *g;
   m_bitmap[(*bitmapPosition)++] = *b;
   m_bitmap[(*bitmapPosition)] = MAXCOLOR;
}
